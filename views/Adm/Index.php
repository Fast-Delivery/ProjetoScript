...
<body>
    <header class="header">
        ...
        <nav class="header-nav">
            <li class="header-li"><a href="#" class="header-a"><i class="fa-solid fa-house"></i> Ranking</a></li>
            <li class="header-li"><a href="#" class="header-a"><i class="fa-solid fa-people-group"></i> Checklist</a></li>
            ...
            <li class="header-li"><a href="#" class="header-a"><i class="fa-solid fa-user"></i> Indicador</a></li>
    ...
    <div class="container-home">
        ...
        <input type="reset" class="submit-form btn btn-green btn-50-size" value="Resetar">
        </section>
 ...
 <section class="section section-form">
            <h1 class="section-title">Inicio Procedimento</h1>
                    ...
                    <div>
                        ...
                        <div class="input-icon">
                            <i class="fa-solid fa-user" ></i>
                                 ...
                                 <!--- Corrigir esse bug -->
                <select class="input-form"  name="assinante" id="assinante" title="Selecione o Estado" required>
               
                <option  class="fa-solid fa-user" value="">Localizar..</option>
                 ...
                 $(document).ready(function() {
                   $('#assinante').select2();
                    ...
                    <div>
                        ...
                        <div class="input-icon">
                            <i class="fa-solid fa-user"></i>
                            <input type="phone" name="phone" id="" class="input-form" placeholder="Insira do telefone" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="input-icon">
                    <i class="fa-solid fa-user"></i>
                    <input type="text" name="endereco" id="" class="input-form" placeholder="Insira o endereço" required>
                </div>
                <div class="form-group">
                    <div>
                        ...
                        <div class="input-icon">
                            ...
                            <input type="email" name="email" id="" class="input-form"
                                placeholder="Insira o e-mail do assinante" required>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="input-icon">
                            ...
                            <!--- Corrigir esse bug -->
                            <select name="nome_grupo" id="nome_grupo" width="50" class="input-form" style="width: %; " required>
